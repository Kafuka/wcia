...
import com.africomgroup.session.CustomerFacade;
...
public class CustomerController implements Serializable {
    ...
    private List<QuoteRequestDetails> details;
    private DataModel items = null;
    @EJB
    private com.africomgroup.session.CustomerFacade ejbFacade;
